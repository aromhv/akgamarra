...
class _ProductsScreenState extends State<ProductsScreen> {
  RetrieveProductRequest request = RetrieveProductRequest(page: 0, items: 10, target: "", category: "");
            ...
            ? FutureBuilder(
              ...
              builder: (context, snapshot) {
                ...
                if (snapshot.connectionState == ConnectionState.waiting) {
                  return Center(
                    child: SizedBox(width: 50, height: 50, child: CircularProgressIndicator(color: ColorEnum.COLOR_PRINCIPAL.color, strokeWidth: 5)),
                  );
                }
